...
export default function TotalIncome() {
    const incomeData = [
      { source: "Fiat + Crypto", amount: "$100,000 + 0.5 BTC", date: "19 March, 2024" },
      { source: "Fiat + Crypto", amount: "$20,000 + 1.2 ETH", date: "08 March, 2024" },
      { source: "Fiat + Crypto", amount: "$27,000 + 0.75 LTC", date: "01 March, 2024" },
    ];

    const currencies = ["AUD", "JTY", "GBP"];
    const [selectedCurrency, setSelectedCurrency] = React.useState("AUD");
        ...
        <div className="space-y-12 mb-28">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md space-y-4">
                ...
                <div className="flex flex-wrap justify-between items-center">
                    {/* Left: Total Crypto Income Text */}
                    <p className="text-black font-bold text-2xl">Total Income</p>

                    {/* Right: Total Price and Dropdown */}
                    <div className="flex items-center space-x-6">
                        <h2 className="text-4xl font-semibold text-black-500">$150,000 + 2.45 BTC</h2>

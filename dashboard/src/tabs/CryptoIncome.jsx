...
export default function CryptoIncome() {
    const incomeData = [
        { amount: "0.5 BTC", date: "19 March, 2024" },
        { amount: "1.2 ETH", date: "08 March, 2024" },
        { amount: "0.75 LTC", date: "01 March, 2024" },
    ];
        ...
        <div className="space-y-12 mb-28">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md space-y-4">
                ...
                <div className="flex flex-wrap justify-between items-center">
                    ...
                    <p className="text-black font-bold text-2xl">Total Crypto Income</p>

                    {/* Right: Total Price and Dropdown */}
                    <div className="flex items-center space-x-4">
                        <h2 className="text-4xl font-semibold text-purple-500">0.0045863</h2>

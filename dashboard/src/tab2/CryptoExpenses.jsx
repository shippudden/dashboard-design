...
export default function CryptoExpenses() {
  const expenses = [
    { item: "VPN Subscription", amount: "0.01 BTC", date: "02 March, 2024" },
    { item: "Cloud Hosting", amount: "0.005 BTC", date: "07 March, 2024" },
    { item: "Gaming Subscription", amount: "0.002 ETH", date: "15 March, 2024" },
  ];
